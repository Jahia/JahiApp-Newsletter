...
<h2><fmt:message key="newsletter.subscription.users.bulkImport"/></h2>
<div class="box-1">
    <form action="${flowExecutionUrl}" method="post" enctype="multipart/form-data" autocomplete="off">

        <fieldset>
            <div class="alert alert-info">
                <label for="csvFile"><fmt:message key="newsletter.subscription.users.csvFile"/></label>
                <input type="file" name="csvFile" id="csvFile"/>
            </div>
            <label for="csvSeparator"><fmt:message key="newsletter.subscription.users.csvFileSeparator"/></label>
            <input class="span6" type="text" name="csvSeparator" value="${csvFileForm.csvSeparator}" id="csvSeparator"/>
        </fieldset>
    ...
    <p>
        <fmt:message key="newsletter.subscriptions.users.batch.file.format"/>
    </p>
</div>